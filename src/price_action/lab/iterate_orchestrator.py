...
def _round_template(round_num: int, best_so_far: dict | None) -> list[dict]:
    ...
    if round_num == 1:
        return [
            {"name": "v1_baseline",          "tp_r": 1.5, "equity": {"risk_pct": 0.005, "max_concurrent": 999}},
            {"name": "v2_risk_red",          "tp_r": 1.5, "equity": {"risk_pct": 0.002, "daily_dd_halt": 0.02, "max_concurrent": 999}},
            {"name": "v3_high_risk",         "tp_r": 1.5, "equity": {"risk_pct": 0.003, "max_concurrent": 999}},
            {"name": "v4_concurrent4",       "tp_r": 1.5, "equity": {"risk_pct": 0.005, "max_concurrent": 4}},
            {"name": "v5_loss_pause3",       "tp_r": 1.5, "equity": {"risk_pct": 0.005, "max_concurrent": 999, "consecutive_loss_pause": 3}},
            {"name": "v6_combo_r2_r4",       "tp_r": 1.5, "equity": {"risk_pct": 0.002, "max_concurrent": 4, "daily_dd_halt": 0.02}},
        ]
    if round_num == 2:
        return [
            {"name": "v7_concurrent6",       "tp_r": 1.5, "equity": {"risk_pct": 0.005, "max_concurrent": 6, "consecutive_loss_pause": 3}},
            {"name": "v8_concurrent4_pause3","tp_r": 1.5, "equity": {"risk_pct": 0.005, "max_concurrent": 4, "consecutive_loss_pause": 3}},
            {"name": "v9_pause2",            "tp_r": 1.5, "equity": {"risk_pct": 0.005, "max_concurrent": 4, "consecutive_loss_pause": 2}},
            {"name": "v10_monthly0.12",      "tp_r": 1.5, "equity": {"risk_pct": 0.005, "max_concurrent": 4, "monthly_dd_halt": 0.12}},
            {"name": "v11_tp2.0",            "tp_r": 2.0, "equity": {"risk_pct": 0.005, "max_concurrent": 999}},
        ]
    if round_num == 3:
        return [
            {"name": "v12_balance",          "tp_r": 1.5, "equity": {"risk_pct": 0.003, "max_concurrent": 6, "daily_dd_halt": 0.025}},
            {"name": "v13_strict_combo",     "tp_r": 1.5, "equity": {"risk_pct": 0.002, "max_concurrent": 4, "consecutive_loss_pause": 3, "daily_dd_halt": 0.015}},
            {"name": "v14_pause4",           "tp_r": 1.5, "equity": {"risk_pct": 0.005, "max_concurrent": 4, "consecutive_loss_pause": 4}},
            {"name": "v15_short_only",       "tp_r": 1.5, "side_only": "short", "equity": {"risk_pct": 0.005, "max_concurrent": 4}},
            {"name": "v16_long_only",        "tp_r": 1.5, "side_only": "long",  "equity": {"risk_pct": 0.005, "max_concurrent": 4}},
        ]
    if round_num == 4:
        return [
            {"name": "v17_pause3_monthly",   "tp_r": 1.5, "equity": {"risk_pct": 0.005, "max_concurrent": 4, "consecutive_loss_pause": 3, "monthly_dd_halt": 0.15}},
            {"name": "v18_pause2_monthly",   "tp_r": 1.5, "equity": {"risk_pct": 0.005, "max_concurrent": 4, "consecutive_loss_pause": 2, "monthly_dd_halt": 0.12}},
            {"name": "v19_r0.004_combo",     "tp_r": 1.5, "equity": {"risk_pct": 0.004, "max_concurrent": 6, "consecutive_loss_pause": 3, "daily_dd_halt": 0.025}},
            {"name": "v20_tp2_pause3",       "tp_r": 2.0, "equity": {"risk_pct": 0.005, "max_concurrent": 4, "consecutive_loss_pause": 3}},
            {"name": "v21_tp2_conc6_pause3", "tp_r": 2.0, "equity": {"risk_pct": 0.005, "max_concurrent": 6, "consecutive_loss_pause": 3}},
        ]
    if round_num == 5:
        return [
            {"name": "v22_tp2.5",            "tp_r": 2.5, "equity": {"risk_pct": 0.005, "max_concurrent": 6, "consecutive_loss_pause": 3}},
            {"name": "v23_tp3.0",            "tp_r": 3.0, "equity": {"risk_pct": 0.005, "max_concurrent": 6, "consecutive_loss_pause": 3}},
            {"name": "v24_tp2_pause2_conc6", "tp_r": 2.0, "equity": {"risk_pct": 0.005, "max_concurrent": 6, "consecutive_loss_pause": 2}},
            {"name": "v25_tp2_monthly",      "tp_r": 2.0, "equity": {"risk_pct": 0.005, "max_concurrent": 4, "consecutive_loss_pause": 3, "monthly_dd_halt": 0.12}},
            {"name": "v26_tp2_conc8",        "tp_r": 2.0, "equity": {"risk_pct": 0.005, "max_concurrent": 8, "consecutive_loss_pause": 3}},
        ]
    if round_num == 6:
        return [
            {"name": "v27_tp3_monthly",      "tp_r": 3.0, "equity": {"risk_pct": 0.005, "max_concurrent": 6, "consecutive_loss_pause": 3, "monthly_dd_halt": 0.12}},
            {"name": "v28_tp3_conc8",        "tp_r": 3.0, "equity": {"risk_pct": 0.005, "max_concurrent": 8, "consecutive_loss_pause": 3}},
            {"name": "v29_tp2.5_conc6_monthly", "tp_r": 2.5, "equity": {"risk_pct": 0.005, "max_concurrent": 6, "consecutive_loss_pause": 3, "monthly_dd_halt": 0.12}},
            {"name": "v30_tp3_pause2",       "tp_r": 3.0, "equity": {"risk_pct": 0.005, "max_concurrent": 6, "consecutive_loss_pause": 2}},
            {"name": "v31_tp3_conc8_pause2", "tp_r": 3.0, "equity": {"risk_pct": 0.005, "max_concurrent": 8, "consecutive_loss_pause": 2}},
        ]
    if round_num == 7:
        ...
        return [
            {"name": f"v32_best_pause2",     "tp_r": best_tp, "equity": {"risk_pct": 0.005, "max_concurrent": best_conc, "consecutive_loss_pause": 2}},
            {"name": f"v33_best_pause2_monthly", "tp_r": best_tp, "equity": {"risk_pct": 0.005, "max_concurrent": best_conc, "consecutive_loss_pause": 2, "monthly_dd_halt": 0.10}},
            {"name": f"v34_best_risk0.004", "tp_r": best_tp, "equity": {"risk_pct": 0.004, "max_concurrent": best_conc, "consecutive_loss_pause": 3}},
            {"name": f"v35_best_conc+1_pause2", "tp_r": best_tp, "equity": {"risk_pct": 0.005, "max_concurrent": best_conc + 2, "consecutive_loss_pause": 2}},
            {"name": f"v36_best_ultra_safe", "tp_r": best_tp, "equity": {"risk_pct": 0.005, "max_concurrent": max(best_conc - 1, 4), "consecutive_loss_pause": 2, "monthly_dd_halt": 0.10}},
        ]
    return []
...
def run_variant_for_strategy(
    ...
    """
    try:
        from iterate_rsi2_variants import _exit_with_be, _load_ohlcv, _compute_metrics, SYMBOLS
        ...
        for sym in SYMBOLS:
            ...
            for sig in signals:
                ...
                R, exit_price, exit_offset = _exit_with_be(
                    ...
                    be_protect=False, trail_pct=None,
                )
                all_trades.append({
                    "entry_ts": sig.ts,
        ...
        eq_series, final_eq, n_taken = _equity_with_loss_pause(
            trades_df, **variant_spec["equity"]
        )
...
def run_orchestrator(*, max_targets_per_run: int = 2, max_variants_per_round: int = 5) -> dict:
    ...
    for tgt in targets:
        ...
        if resolved is None:
            ts["status"] = "failed"
            ts["errors"].append({"ts": datetime.now(timezone.utc).isoformat(),
                                 "err": f"No strategy mapping for {target_id}"})
        ...
        if not variants:
            ts["errors"].append({"ts": datetime.now(timezone.utc).isoformat(),
                                 "err": f"No template for round {next_round}"})
        ...
        for v in variants:
            ...
            try:
                ...
                # Track best
                if result["status"] == "OK":
                    if ts["best_variant"] is None or result.get("monthly_roi", -999) > ts["best_variant"].get("monthly_roi", -999):
                ...
                if result.get("tier") in NOTIFY_TIERS:
                    ...
                    summary["promotes_found"].append({
                        "target": target_id, "round": next_round,
                        "variant": spec["name"], "tier": result["tier"],
                        "roi": result["monthly_roi"], "dd": result["max_dd"],
                    })
            except Exception as exc:
                ts["errors"].append({"ts": datetime.now(timezone.utc).isoformat(),
                                     "variant": spec["name"],
                                     "err": str(exc)[:200]})
                summary["errors"].append({"target": target_id, "variant": spec["name"],
                                          "err": str(exc)[:100]})
        ...
        ts["last_round_at"] = datetime.now(timezone.utc).isoformat()
        ...
        round_dump.write_text(json.dumps({
            "target": target_id,
            "round": next_round,
