...
# (plist'i adım 2'deki içerikle yaz — Write tool ile)
...
- Bu skill SADECE güç/uyku ayarını yönetir — botları başlatmaz/durdurmaz (o ayrı launchd job'ları: `com.priceaction.futures_v14`, `com.priceaction.futures5m`).
